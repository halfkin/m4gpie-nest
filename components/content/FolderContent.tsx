...
export interface FolderItem {
    ...
    size: string;
    color: string;
    // Optional extra data for specific handling if needed
    [key: string]: any;
}
...
export function FolderContent({ items, onOpenItem }: FolderContentProps) {
                ...
                <div style={{ flex: 1, overflow: "auto", background: "white" }}>
                    ...
                    {items.map((p, i) => (
                        ...
                        >
                            ...
                            >
                                <i className="ph-fill ph-file" style={{ fontSize: 16, color: selected === p.id ? "white" : p.color }} />
